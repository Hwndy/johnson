...
const Portfolio: React.FC<PortfolioProps> = ({ onLogout, userEmail }) => {
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="flex items-center gap-4 ml-4 pl-4 border-l border-gray-200">
                <span className="text-sm text-gray-600 font-inter">{userEmail}</span>
                <button
                  onClick={onLogout}
                  className="flex items-center gap-2 text-gray-600 hover:text-red-600 transition-colors font-poppins"
                >
          ...
          <div className="md:hidden bg-white border-t border-gray-100 shadow-2xl">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <div className="border-t border-gray-200 pt-2 mt-2">
                <div className="px-3 py-2 text-sm text-gray-600 font-inter">{userEmail}</div>
                <button
                  onClick={onLogout}
                  className="flex items-center gap-2 w-full text-left px-3 py-2 text-red-600 hover:bg-red-50 rounded-md transition-all font-poppins"
                >
                  <LogOut className="w-4 h-4" />
                  <span>Logout</span>
                </button>
